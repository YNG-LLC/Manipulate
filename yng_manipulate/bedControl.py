	...
	# Bed 16
		...
		if ((BedType == "reveal3D") or (BedType == "FRANK3") and  (DUPE_CHECK == 0)):
			...
			if zoneActivatedREVEAL3D[2] == 3:
				cloneFile.write("B16 P2 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[3] == 4:
				cloneFile.write("B16 P3 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[4] == 5:
				cloneFile.write("B16 P4 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[5] == 6:
				cloneFile.write("B16 P5 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			...
			if zoneActivatedREVEAL3D[8] == 9:
				cloneFile.write("B16 P8 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[9] == 10:
				cloneFile.write("B16 P9 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[10] == 11:
				cloneFile.write("B16 P10 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[11] == 12:
				cloneFile.write("B16 P11 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[12] == 13:
				cloneFile.write("B16 P12 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[13] == 14:
				cloneFile.write("B16 P13 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[14] == 15:
				cloneFile.write("B16 P14 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[15] == 16:
				cloneFile.write("B16 P15 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			...
			if zoneActivatedREVEAL3D[1] == 2:
				cloneFile.write("B16 P1 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[2] == 3:
				cloneFile.write("B16 P2 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[3] == 4:
				cloneFile.write("B16 P3 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[4] == 5:
				cloneFile.write("B16 P4 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[5] == 6:
				cloneFile.write("B16 P5 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[6] == 7:
				cloneFile.write("B16 P6 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[7] == 8:
				cloneFile.write("B16 P7 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			...
			if zoneActivatedREVEAL3D[9] == 10:
				cloneFile.write("B16 P9 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[10] == 11:
				cloneFile.write("B16 P10 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[11] == 12:
				cloneFile.write("B16 P11 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[12] == 13:
				cloneFile.write("B16 P12 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[13] == 14:
				cloneFile.write("B16 P13 " + "S" + str(TOOL_BED2)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[14] == 15:
				cloneFile.write("B16 P14 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
			if zoneActivatedREVEAL3D[15] == 16:
				cloneFile.write("B16 P15 " + "S" + str(TOOL_BED1)+" E1" + waitTime)
